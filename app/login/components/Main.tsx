...
export const Main = () => {
  ...
  const translatedError = error?.code
    ? (authErrorMessages[error.code] ?? "Não foi possível entrar na sua conta.")
    : "";
      ...
      <div className="surface-card-strong grid w-full max-w-6xl overflow-hidden lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm uppercase tracking-[0.34em] text-[#94A3BB]">
                  Sistema financeiro
                </p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-semibold leading-tight">
                Entre e acompanhe suas finanças com uma experiência mais
                moderna.
              </h2>
            </div>
          </div>
          <div className="grid gap-3 text-sm dark:text-[#CBD5E1]">
            <p className="rounded-2xl border dark:border-white/10 dark:bg-white/5 px-4 py-4 backdrop-blur-sm">
              Controle receitas, despesas e cartões em um único lugar.
            </p>
            <p className="rounded-2xl border dark:border-white/10 dark:bg-white/5 px-4 py-4 backdrop-blur-sm">
              Visual refinado, leitura fácil e foco no que realmente importa.
            </p>
          </div>
        </div>
        <div className="p-6 sm:p-8 lg:p-10">
          <div className="mb-8 flex items-center gap-4 lg:hidden">
            <div>
              <Image
                ...
                width={40}
                height={40}
                className="h-10 w-10 object-container rounded"
              />
            </div>
            <div>
              ...
              <p className="text-[11px] uppercase tracking-[0.28em] text-[#94A3BB]">
                Sistema financeiro
              </p>
            </div>
          </div>
          <div className="space-y-3 text-left">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-[#0F172A] dark:text-white">
              Entrar
            </h2>
            <p className="max-w-md text-sm leading-6 text-[#64748B] dark:text-[#94A3BB]">
              Faça login para visualizar seu painel, acompanhar movimentações e
              manter sua vida financeira organizada.
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-4 text-left">
            ...
            <p className="text-sm text-[#64748B] dark:text-[#94A3BB]">
              ...
              <Link
                href="/register"
                className="font-semibold text-[#15803D] underline-offset-4 hover:underline dark:text-[#4ADE80]"
              >
                Cadastre-se agora
              </Link>
              .
