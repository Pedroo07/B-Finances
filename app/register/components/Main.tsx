...
export const Main = () => {
  ...
  const handleSignIn = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (!isValidLength) {
      setLocalError(
        "Por favor, insira um número de telefone válido com DDD (ex: 11 99999-9999).",
      );
      return;
    }
    ...
    try {
      ...
      toast.error(
        authErrorMessages[errorCode] ?? "Não foi possível concluir o cadastro.",
      );
    }
  };
        ...
        <div className="hidden p-10 dark:text-white lg:flex lg:flex-col lg:justify-between">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-semibold leading-tight">
                Crie sua conta e organize receitas, despesas e cartões com mais
                clareza.
              </h2>
            </div>
          </div>
          <div className="grid gap-3 text-sm dark:text-[#CBD5E1]">
            <p className="rounded-2xl border dark:border-white/10 dark:bg-white/5 px-4 py-4 backdrop-blur-sm">
              Uma interface mais moderna para acompanhar tudo com rapidez.
            </p>
            <p className="rounded-2xl border dark:border-white/10 dark:bg-white/5 px-4 py-4 backdrop-blur-sm">
              Paleta refinada, leitura confortável e foco no essencial.
            </p>
          </div>
        </div>
        <div className="p-6 sm:p-8 lg:p-10">
          ...
          <div className="space-y-3 text-left">
            ...
            <p className="max-w-md text-sm leading-6 text-[#64748B] dark:text-[#94A3BB]">
              Abra sua conta para acompanhar seu financeiro em um painel
              moderno, organizado e pronto para o dia a dia.
            </p>
          </div>
